...
exports.list = function (userId){
    var notifications = db.prepare("select  n.id , n.type , n.from_id , n.receiver_id , n.date , u.last_name as fromUserLastName, u.first_name as fromUserFirstName from notifications n join users u on from_id = u.id where receiver_id = ?  ").all(userId);
    return notifications;
}

exports.delete = function(notification){
    db.prepare("delete from notifications where from_id = @from_id and receiver_id = @receiver_id and type = @type ").run(notification);
